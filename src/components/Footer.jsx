        ...
        <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
            <div className='grid mb-8 lg:grid-cols-6'>
                <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                   ...
                   <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li>
                                <a href='/' className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>E-commmerce</a>
                            </li>
                            <li>
                   ...
                   <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li>
                                <a href='/' className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Presonal</a>
                            </li>
                            <li>
                                <a href='/' className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Wikit</a>
                            </li>
                            <li>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, ea dignissimos nobis, ad magnam debitis itaque reprehenderit veritatis labore repellendus rem ullam dolorem molestias vitae magni quidem ipsum animi voluptates.</p>
