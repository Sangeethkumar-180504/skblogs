    ...
    <div className='px-4 py-32 bg-black mx-auto'>
        <div className='text-white text-center'>
            ...
            <p className='text-gray-100 lg:w-3/5 mx-auto mb-5 font-primary'>
                Start your blod today anf join a community of writers and readers who are passionate about sharing their stories aand ideas. We offer everything you need to get started, from helpful tips and tutorials.
            </p>
            <div>
